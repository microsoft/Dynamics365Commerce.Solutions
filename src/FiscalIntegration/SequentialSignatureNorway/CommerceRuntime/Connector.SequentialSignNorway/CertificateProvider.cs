...
namespace Contoso
{
    namespace CommerceRuntime.Connector.SequentialSignNorway
    {
        ...
        using Contoso.CommerceRuntime.Connector.SequentialSignNorway.Configuration;
        using Contoso.CommerceRuntime.Connector.SequentialSignNorway.Entities;
        using Contoso.CommerceRuntime.Connector.SequentialSignNorway.Enums;

...
namespace Contoso
{
    namespace CommerceRuntime.DocumentProvider.EFRSample.Messages
    {
        ...
        public sealed class PopulateCountryRegionSpecificPositionsRequest: Request
        {
            /// <summary>
            /// Initializes a new instance of <see cref="PopulateCountryRegionSpecificPositionsRequest"/>.
            /// </summary>
            public PopulateCountryRegionSpecificPositionsRequest(List<ReceiptPosition> receiptPositions, SalesOrder salesOrder, FiscalIntegrationFunctionalityProfile fiscalIntegrationFunctionalityProfile)
            {

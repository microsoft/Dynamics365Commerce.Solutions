...
namespace Contoso
{
    namespace CommerceRuntime.DocumentProvider.AtolSample.DataModel.AtolTask
    {
        ...
        /// <summary>
        /// Represent task to close the shift on the printer.
        /// </summary>
        [DataContract]
        public class AtolCloseShiftTask
        {
            /// <summary>
            ...
            public string Type
            {
                get { return AtolTaskTypes.CloseShift; }
            }
            ...
            /// <summary>
            /// Gets or sets a value indicating whether the z-report should be generated electronically only..
            /// </summary>
            [DataMember(Name = "electronically", EmitDefaultValue = false)]
            public bool ElectronicForm { get; set; }
        }
    }
}

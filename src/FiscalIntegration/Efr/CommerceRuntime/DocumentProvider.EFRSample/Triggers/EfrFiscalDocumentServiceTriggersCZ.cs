            ...
            public async Task OnExecuted(Request request, Response response)
            {
                switch (request)
                {
                    ...
                    case PopulateCountryRegionSpecificPositionsRequest populateCountryRegionSpecificPositionsRequest:
                        ...
                        break;
                    case PopulateEfrLocalizationInfoToPaymentRequest ropulateEfrLocalizationInfoToPaymentRequest:
                        PopulateEfrLocalizationInfoToPayment(ropulateEfrLocalizationInfoToPaymentRequest, (SingleEntityDataServiceResponse<ReceiptPayment>)response);
                        break;
                }
            }

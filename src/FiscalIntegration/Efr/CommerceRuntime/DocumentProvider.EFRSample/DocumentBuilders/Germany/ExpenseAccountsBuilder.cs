...
namespace Contoso
{
    namespace CommerceRuntime.DocumentProvider.EFRSample.DocumentBuilders.GermanyBuilders
    {
        ...
        public class ExpenseAccountsBuilder : IDocumentBuilder
        {
            ...
            private ExpenseAccountsBuilder(DocumentBuilderData documentBuilderData)
            {
            ...
            public static async Task<ExpenseAccountsBuilder> Create(DocumentBuilderData documentBuilderData)
            {
                var instance = new ExpenseAccountsBuilder(documentBuilderData);

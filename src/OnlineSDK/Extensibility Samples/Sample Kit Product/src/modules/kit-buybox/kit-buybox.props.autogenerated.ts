 ...
 * IKitBuybox containerModule Interface Properties
...
export interface IKitBuyboxConfig extends Msdyn365.IModuleConfig {
...
export interface IKitBuyboxResources {
...
export interface IKitBuyboxProps<T> extends Msdyn365.IModule<T> {
    resources: IKitBuyboxResources;
    config: IKitBuyboxConfig;
    slots: {

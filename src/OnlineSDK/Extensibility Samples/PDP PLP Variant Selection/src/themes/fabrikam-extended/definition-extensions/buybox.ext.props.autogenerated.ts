...
export interface IBuyboxConfig extends Msdyn365.IModuleConfig {
    ...
    sizingChartImageSettings?: Msdyn365.IImageSettings;
    sizingChartFileTemplate?: string;
    brandImageFileTemplate?: string;
    renderSwatches?: boolean;
    defaultColorHex?: string;
    enableVariantsOOSInventoryCheck?: boolean;
    renderColorSwatchImages?: boolean;
    finalSaleRichText?: Msdyn365.RichText;
    selectColorDimensionOnloadFlag?: boolean;
}
...
export interface IBuyboxResources {
    ...
    sizingChartText: string;
    sizingChartButtonText: string;
    styleNumberText: string;
    viewStoreAvailabilityText: string;
    addedToCartMessageText: string;
}
...
export interface IBuyboxProps<T> extends Msdyn365.IModule<T> {
    ...
    slots: {
        ...
        freeReturnsContent: React.ReactNode[];
        StoreSelector: React.ReactNode[];
        MediaGallery: React.ReactNode[];
    };
}

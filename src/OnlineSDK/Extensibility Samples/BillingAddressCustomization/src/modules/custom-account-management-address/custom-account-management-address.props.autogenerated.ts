...
export interface ICustomAccountManagementAddressConfig extends Msdyn365.IModuleConfig {
    ...
    billingAddressSectionHeading?: IBillingAddressSectionHeadingData;
...
export const enum BillingAddressSectionHeadingTag {
    h1 = 'h1',
    h2 = 'h2',
    h3 = 'h3',
    h4 = 'h4',
...
export interface IBillingAddressSectionHeadingData {
    text: string;
    tag?: BillingAddressSectionHeadingTag;
}

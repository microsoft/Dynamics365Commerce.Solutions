...
const url = 'http://localhost:4000/page?mock=order-confirmation&mockUser=false';
fixture('validate order confirmation page').page(url).beforeEach(async testController => {

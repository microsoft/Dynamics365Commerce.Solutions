...
const url = 'http://localhost:4000/page?mock=order-details&mockUser=true&theme=summer';
fixture('validate order details page').page(url).beforeEach(async testController => {

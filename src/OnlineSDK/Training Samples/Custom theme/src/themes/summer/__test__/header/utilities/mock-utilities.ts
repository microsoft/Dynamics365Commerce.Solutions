...
export const mockResources = {
    ...
    emailNotRegisteredTitle: 'Error message if customer is not registered at HQ in B2B Contact model',
    accountMobileHeaderCloseAriaLabel: 'Close account mobile header'
};

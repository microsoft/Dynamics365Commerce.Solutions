...
namespace Contoso.CommerceRuntime.PricingEngine
{
    ...
    /// <summary>
    /// Amount cap discount data accessor interface.
    /// </summary>
    /// <remarks>Data accessor interface to support both Channel and AX.</remarks>
    public interface IDataAccessorDiscountAmountCap
    {
        /// <summary>
        ...
        Task<object> GetDiscountAmountCapsByOfferIdsAsync(IEnumerable<string> offerIds);
    }
}

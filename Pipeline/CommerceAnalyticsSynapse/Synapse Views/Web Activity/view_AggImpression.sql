CREATE OR ALTER VIEW [dbo].[view_AggImpression] AS
	SELECT * 
	FROM
		OPENROWSET
		( 
			BULK N'https://placeholder_storageaccount.dfs.core.windows.net/placeholder_container/placeholder_datarootpath/Ontologies/Commerce/AggImpression/*.parquet',
			FORMAT='parquet'
		)
		WITH
		(
